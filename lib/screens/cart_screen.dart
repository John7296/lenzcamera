            ...
            child: SingleChildScrollView(
                                    ...
                                    Stack(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Row(
                                            children: [
                                              Text("CANON LP-E6NH BATTERY(OG)", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600), maxLines: 2),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text("QAR 549.00", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600), maxLines: 2),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(child: Text("Subtotal: ", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),)),
                          // SizedBox(
                          //   width: 220,
                          // ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                    Expanded(child: Text("Delivery: ", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),)),
                    //  SizedBox(
                    //           width: 240,
                    //         ),
              ...
              Padding(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                       Expanded(child: Text("Total: ", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500),)),
