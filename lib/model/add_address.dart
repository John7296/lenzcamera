...
class AddAddress {
  ...
  AddAddress({
    this.addLine1,this.addLine2,this.addressType,this.country,this.custId,this.district,this.firstName,this.isDefaultBillingAddress,this.isDefaultShippingAddress,this.landmark,this.lastName,this.latitude,this.longitude,this.phone,this.pincode,this.state
